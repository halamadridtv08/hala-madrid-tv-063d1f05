        ...
        <div className="madrid-container py-8">
          <div className="flex flex-col lg:flex-row gap-8 mb-12">
            <div className="lg:w-1/4">
              {mainCoach && <CoachCard name={mainCoach.name} title={mainCoach.role} nationality={mainCoach.nationality || "Italienne"} birthDate={mainCoach.birth_date || undefined} atClubSince={mainCoach.at_club_since || undefined} image={mainCoach.image_url} achievements={coachAchievements} />}
            </div>
