...
const Index = () => {
  ...
  const { t } = useLanguage();
  const { cards, loading: cardsLoading, getIconComponent } = useExploreCards();
                ...
                cards.map((card) => {
                  ...
                  return (
                    <Card key={card.id} className="card-hover">
                      <CardContent className="p-3 sm:p-4 md:p-6 text-center flex flex-col items-center">
                        <IconComponent className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-madrid-blue mb-2 sm:mb-3 md:mb-4" />
