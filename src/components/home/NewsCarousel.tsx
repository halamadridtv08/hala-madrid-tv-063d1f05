  ...
  const slides = [
    {
      ...
      description: "La star française rejoint enfin le club madrilène",
    ...
    {
      id: 2,
      title: "Victoire 3-0 contre Barcelone",
      description: "Le Real Madrid s'impose avec autorité dans le Clasico",
    ...
    },
    {
      ...
      description: "Le milieu anglais continue d'impressionner",
