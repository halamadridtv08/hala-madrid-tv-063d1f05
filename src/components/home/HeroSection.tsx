...
export function HeroSection() {
  ...
  return <>
      <motion.div className="relative overflow-hidden bg-madrid-blue/40" initial={{
      opacity: 0
    }} animate={{
      opacity: 1
    }} transition={{
      duration: 0.8
        ...
        <div className="madrid-container py-8 sm:py-12 md:py-16 lg:py-24 xl:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <motion.div className="w-full h-[300px] sm:h-[400px] lg:h-[500px] flex justify-center items-center" initial={{
            x: 50,
            opacity: 0
          }} animate={{
            x: 0,
            ...
            delay: 0.4
              ...
              {isLoading ? <Skeleton className="w-full h-full rounded-xl" /> : videoUrl ? <video className="w-full h-full rounded-xl object-cover shadow-2xl" autoPlay muted loop playsInline key={videoUrl}>
