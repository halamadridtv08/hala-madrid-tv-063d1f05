...
const ENTRY_TYPES = [
  ...
  { value: 'free_kick_goal', label: 'But sur coup franc', emoji: '🎯' },
  ...
  { value: 'penalty_goal', label: 'But sur penalty', emoji: '⚽' },
  { value: 'penalty_missed', label: 'Penalty manqué', emoji: '⛔' },
  { value: 'second_yellow_card', label: 'Deuxième jaune', emoji: '🟨🟥' },
