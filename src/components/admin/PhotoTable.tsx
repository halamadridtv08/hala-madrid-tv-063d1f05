...
const PhotoTable = ({ photos, setPhotos }: PhotoTableProps) => {
  ...
  const [editingPhoto, setEditingPhoto] = useState<PhotoType | undefined>(undefined);
  ...
  const refreshPhotos = async () => {
    try {
      ...
      toast.error("Erreur lors du rechargement des photos");
    }
  };
  ...
  const handleEditPhoto = (photo: PhotoType) => {
