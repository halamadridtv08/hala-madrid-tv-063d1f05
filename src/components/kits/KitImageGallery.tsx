        ...
        <div className="overflow-hidden rounded-lg h-full bg-muted/10" ref={mainViewportRef}>
          <div className="flex h-full">
            {sortedImages.map((image, index) => <div key={image.id} className="relative flex-[0_0_100%] min-w-0 h-full">
                ...
                {/* Zoom Button */}
                <Button size="icon" variant="secondary" onClick={() => openZoom(index)} className="absolute top-4 right-4 h-10 w-10 rounded-full bg-background/80 hover:bg-background text-madrid-white mx-[15px] my-[10px]">
