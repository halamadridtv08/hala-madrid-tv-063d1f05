  ...
  return (
    <div className={`grid grid-cols-2 gap-6 max-w-[200px] mx-auto ${className}`}>
      ...
      >
        ...
        <div className="relative z-10">
          <svg className="w-7 h-7 fill-current text-blue-500 group-hover:text-blue-400 transition-colors duration-300" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <div className="relative z-10">
          <svg className="w-7 h-7 fill-current text-pink-500 group-hover:text-pink-400 transition-colors duration-300" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <div className="relative z-10">
          <svg className="w-7 h-7 fill-current text-white group-hover:text-white/90 transition-colors duration-300" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
